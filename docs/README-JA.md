...
> [!NOTE]
> **Global Infrastructure Standard:** 僕の主要プロジェクトは5言語（EN, TH, ZH, JA, KO）でドキュメントを用意しています。正確な情報は、読み手の言語で伝えてこそ意味があると考えているからです。
...
*   **特徴:** 5言語でドキュメントを用意。Bot本体も対応。

#### [Yosafe](https://github.com/welltilln/yosafe)
**資産管理システム**
*   **概要:** 僕はForexをトレードしているので、トレードのマネーマネジメントを助けるシステムを作りました。銀行残高の記録も追加し、メールからAIでデータを取得しています。
...
**AIエージェント障害記録**
*   **概要:** AI Agentを使っているとよく壊れるので、どこで壊れたか、原因は何かを記録し始めました。他の人にも記録を手伝ってほしい、community vibe coding的なプロジェクトです。
*   **特徴:** 実際にSystem Promptの改善に活かせました。
...
<p align="center"><i>実際に使えるものを作るのが好きです。</i></p>
