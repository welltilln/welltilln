...
> [!NOTE]
> **Global Infrastructure Standard:** โปรเจคหลักของผมทำคู่มือไว้ 5 ภาษา (EN, TH, ZH, JA, KO)
...
*   **จุดเด่น:** ทำคู่มือไว้ 5 ภาษา ทั้งเอกสารและตัว Bot เอง

#### [Yosafe](https://github.com/welltilln/yosafe)
**ระบบช่วยจัดการเงินและสินทรัพย์**
*   **ทำอะไร:** ผมเทรด Forex อยู่ เลยต้องทำระบบช่วยจัดการ Money Management ในการเทรด แล้วก็เพิ่มให้บันทึกเงินในธนาคารด้วย ดึงข้อมูลจากเมลผ่าน AI
...
**คลังบันทึก AI Agent พัง**
*   **ทำอะไร:** ตอนใช้ AI Agent ทำงาน มันพังบ่อย ผมเลยเริ่มจดไว้ว่ามันพังตรงไหน เกิดจากอะไร อยากให้คนอื่นมาช่วยกันบันทึกด้วย เป็นแนว community vibe coding
*   **จุดเด่น:** เอาไปปรับ System Prompt ให้ดีขึ้นได้จริง
...
<p align="center"><i>ผมชอบทำของที่ใช้ได้จริง</i></p>
